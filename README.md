...
- Libro Digital: верный ID папки с MP3, когда он не совпадает с ID упражнения; CDN `blinklearning.net` снова в allowlist.
- Надёжнее находится имя трека с суффиксом (`PISTA30_753257.mp3`) на странице упражнения.

### Что нового в 1.2.0

- Исправлено автообновление на macOS (зависание на «Установка обновления»).
- Скачивание аудио с суффиксом в имени файла (`PISTA30_753257.mp3`) для Libro Digital.
