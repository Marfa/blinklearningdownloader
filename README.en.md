...
| macOS (Apple Silicon) | `BlinkLearning-Downloader-1.2.2-mac-arm64.zip` | `.app` in a zip |
...
- Libro Digital: use the MP3 upload folder ID when it differs from the exercise ID; allow CDN hosts on `blinklearning.net` again.
- More reliable detection of suffixed track names (`PISTA30_753257.mp3`) from the exercise page.
